...
Giudici's Theorem 1.1 and Tables 1--2 cover simple sporadic groups;
Theorem 1.2 and Table 3 give the genuinely new outer cases; Theorem 1.3 and
Table 4 list only exact factorizations; and Lemma 2.1(5) accounts for lifted
simple-socle rows.  Factor-freeness requires the complete lists in Tables
1--3 rather than the exact-only list in Table 4.  The following maximal
subgroups do not
